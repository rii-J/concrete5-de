	...
	<?php  }else{ ?>
		...
		<?php  foreach($globalScrapbookBlocks as $b){ 
			...
			<div class="ccm-scrapbook-list-item" id="ccm-scrapbook-list-item-<?php echo intval($b->bID) ?>"> 
				<div class="ccm-block-type">
					<a class="ccm-scrapbook-delete" title="<?php  echo t('Remove from Scrapbook')?>" href="javascript:void(0)" arHandle="<?php echo addslashes($scrapbookName)?>" id="scrapbook-bID<?php echo intval($b->bID) ?>"><img src="<?php echo ASSETS_URL_IMAGES?>/icons/delete_small.png" width="16" height="16" /></a>				
