...
if ($tp1->canAccessTaskPermissions()) { 
	...
	<div class="ccm-dashboard-inner">
		<form method="post" id="sitemap-permissions" action="<?php echo $this->url('/dashboard/sitemap/access', 'save_permissions')?>">
			...
			<?php  print $h->getForm($tp, t('Add users or groups to determine access to the sitemap. <strong>Note:</strong> If you want users to have access to the dashboard sitemap, they must be entered here and in the dashboard sitemap page permissions area.')); ?>
