...
<?php   
	if (!$tp->canInstallPackages()) { ?>
		...
		<p class="ccm-error"><?php  echo t('You do not have access to download themes or add-ons from the marketplace.')?></p>
	<?php   } else if (!$mi->isConnected()) { ?>
...
<?php   } else if ($this->controller->getTask() == 'update' && $tp->canInstallPackages()) { 
